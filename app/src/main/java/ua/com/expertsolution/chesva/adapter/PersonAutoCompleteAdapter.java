...
public class PersonAutoCompleteAdapter extends FilterAutoCompleteAdapter implements Filterable {
    ...
    public PersonAutoCompleteAdapter(Context context) {
        super(context);
    ...
    public Object getItem(int position) {
        try {
            return ((Person)suggestions.get(position)).getFullName();
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public boolean isMoreOne(String value){
        return CollectionUtils.select(originalList, (Predicate) sample -> ((Person) sample).getFullName().toUpperCase()
                    ...
                    try {
                        suggestions.addAll(CollectionUtils.select(originalList, new Predicate() {
                            public boolean evaluate(Object sample) {
                                return ((Person) sample).getFullName().toUpperCase()
