...
public class FilterAutoCompleteAdapter extends BaseAdapter implements Filterable {
    ...
    public FilterAutoCompleteAdapter(Context context) {
    ...
    public Object getItem(int position) {
        try {
            return ((Object) suggestions.get(position));
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            autoText.setText((String)suggestions.get(position));
        }catch (Exception e){
            Log.e(TAGLOG, e.toString());
        }
                    ...
                    try {
                        suggestions.addAll(CollectionUtils.select(originalList, new Predicate() {
                            public boolean evaluate(Object sample) {
                                return ((String) sample).toUpperCase()
